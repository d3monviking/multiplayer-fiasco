...
public final class PlayerData extends Table {
  ...
  public int lastProcessedSeqNumber() { int o = __offset(10); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  ...
  public static void addLastProcessedSeqNumber(FlatBufferBuilder builder, int lastProcessedSeqNumber) { builder.addInt(3, lastProcessedSeqNumber, 0); }
